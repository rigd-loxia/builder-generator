...
public class JavaFileAssert extends FileAssert {
    ...
    /**
     * Verifies that the expected file has the same content as this Java file. The verification ignores the license header and the
     * date/comments line from the {@code @Generated} annotation.
     *
    ...
    public void hasSameMapperContent(File expected) {
        ...
        try {
            List<Delta<String>> diffs = new ArrayList<>(diff.diff(
                actual,
                charset,
                expected,
                charset));
    ...
    /**
     * Checks if the delta should be ignored. The delta is ignored if it is a deletion type for the license header or if it is a
     * change delta for the date/comments part of a {@code @Generated} annotation.
     *
