...
/**
 * A parallel capable class loader for which additional URLs can be added after construction, and that will force classes from
 * org.mapstruct.at.test.** packages to be loaded with this instance
 *
 * @author Andreas Gudian
 */
final class ModifiableURLClassLoader extends URLClassLoader {

    private static final String ORG_MAPSTRUCT_AP_TEST = "nl.loxia.builder.generator.ap.test.";
